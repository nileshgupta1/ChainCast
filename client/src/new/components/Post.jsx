...
const Post = ({ postContent, userName, title ,imgSrc}) => {
    ...
    return (
        <div className='sm:whitespace-normal sm:w-[650px] md:w-full lg:w-[800px] flex flex-col justify-center rounded-xl shadow-xl items-center bg-white border border-black mb-8'>
            ...
            <div className='flex flex-col justify-center w-full items-center'>
                <div className='flex flex-row w-full justify-between mt-5'>
                    <PostSideBar />
                    <div className={`flex flex-col ${expand ? "overflow-y-auto" : "h-80 overflow-y-clip"} w-full`} onClick={()=>{
                        setExpand(true);
                    }}>
                        ...
                        <div className='py-4 text-clip px-4 ml-5 mr-5 flex justify-center'>
                            <img className = {`rounded-md ${expand ? "" : "img-gradient -z-2"}`} src = {imgSrc} alt = "image"/>
                        </div>
                    </div>
                </div>
                <div>
