...
const AddPost = ({setIsComponentVisible,reference,setOpenAddPosts,cidArr,setCidArr,setMainCid,mainCid,data,setData})=>{
    ...
    return ReactDOM.createPortal(
        <> 
            <div className="sidebar-blur rounded-none fixed flex justify-center items-center modal-blur w-screen h-screen z-10">
                <div ref = {reference} className="bg-white w-2/5 h-3/4 flex flex-col justify-between rounded-xl items-center">
                    ...
                    <div className="flex flex-row justify-end items-center w-full h-[65px]">
                    {
                        isLoading ?
