    ...
    return (
        <div className="flex flex-row px-2 py-3">
            <div className='flex flex-row items-center px-2 py-2 group cursor-pointer'>
                ...
                <p className=' text-slate-800 text-gradient font-bold text-md px-2 py-2 group-hover:font-extrabold cursor-pointer'>Comments</p>
            </div>
            <div className='flex flex-row justify-center group items-center px-2'>
                <AiOutlineShareAlt fontSize={20} />
                <p className=' text-slate-800 text-gradient font-bold text-md px-2 group-hover:font-extrabold cursor-pointer'>Share</p>
            </div>
            <div className='flex flex-row justify-center group items-center px-2'>
                <BsSave fontSize={20} />
                <p className=' text-slate-800 text-gradient font-bold text-md px-2 group-hover:font-extrabold cursor-pointer'>Save</p>
            </div>
            <div className='flex flex-row justify-center group items-center px-2'>
                <BsCoin fontSize={20} />
                <p className=' text-slate-800 text-gradient font-bold text-md px-2 group-hover:font-extrabold cursor-pointer'>Tip</p>
            </div>
            <div className='flex flex-row justify-center group items-center px-2'>
                <p className=' text-slate-800 text-gradient font-bold text-md px-2 group-hover:font-extrabold cursor-pointer'>More...</p>
            </div>
            {/* <div>Share</div>
        <div>Save</div>
        <div>Tip</div>
